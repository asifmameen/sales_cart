...
export default function EditDiscountDialog({ open, initial, onClose, onSave, }) {
    ...
    return (_jsxs(Dialog, { open: open, onClose: onClose, maxWidth: "sm", fullWidth: true, children: [_jsx(DialogTitle, { className: "adddisc-title", children: "Edit discount" }), _jsxs(DialogContent, { className: "adddisc-content", children: [_jsx(Typography, { className: "adddisc-label", children: "For which price do you calculate the discount?" }), _jsxs(ToggleButtonGroup, { exclusive: true, value: scope, onChange: (_, val) => val && setScope(val), className: "adddisc-scope", children: [_jsxs(ToggleButton, { value: "one-time", className: "pill", children: [_jsx("span", { children: "One time price" }), scope === "one-time" && (_jsx(CheckCircleOutline, { fontSize: "small", className: "pill-check" }))] }), _jsxs(ToggleButton, { value: "monthly", className: "pill", children: [_jsx("span", { children: "Monthly price" }), scope === "monthly" && (_jsx(CheckCircleOutline, { fontSize: "small", className: "pill-check" }))] })] }), _jsxs("div", { className: "adddisc-row", children: [_jsxs(FormControl, { className: "adddisc-type", children: [_jsx(InputLabel, { id: "edit-disc-type-label", children: "Type" }), _jsxs(Select, { labelId: "edit-disc-type-label", label: "Type", value: kind, onChange: handleKindChange, children: [_jsx(MenuItem, { value: "percent", children: "% Percentage" }), _jsx(MenuItem, { value: "amount", children: "\u20AC Euro" })] })] }), _jsx(TextField, { className: "adddisc-value", label: kind === "percent" ? "Discount (%)" : "Discount (€)", type: "number", value: valueInput, onChange: (e) => setValueInput(e.target.value), inputProps: { min: 0, step: "1" } })] }), scope === "monthly" && (_jsx(TextField, { label: "Duration", placeholder: "Number of months", type: "number", value: duration, onChange: (e) => setDuration(e.target.value), className: "adddisc-field", inputProps: { min: 1, step: "1" } })), _jsx(TextField, { label: "Description", value: description, onChange: (e) => setDescription(e.target.value), className: "adddisc-field" }), _jsx(TextField, { label: "Name", value: name, onChange: (e) => setName(e.target.value), className: "adddisc-field" })] }), _jsxs(DialogActions, { className: "adddisc-actions", children: [_jsx(Button, { onClick: onClose, variant: "text", children: "Cancel" }), _jsx(Button, { onClick: handleSave, variant: "contained", children: "Save" })] })] }));
}
